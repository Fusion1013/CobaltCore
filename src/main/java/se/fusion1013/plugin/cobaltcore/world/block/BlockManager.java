...
public class BlockManager extends Manager implements CommandExecutor, Listener {
    ...
    public BlockManager(CobaltCore cobaltCore) {
        super(cobaltCore);
        INSTANCE = this;
    }
    ...
    public static BlockManager getInstance(){
        if (INSTANCE == null){
            INSTANCE = new BlockManager(CobaltCore.getInstance());
        }
        return INSTANCE;
    }
