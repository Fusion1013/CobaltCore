...
public class ParticleEffectManager extends Manager<CobaltCore> {
    ...
    public static final IParticleEffect PARTICLE_EFFECT_FIBONACCI_SPHERE =
            register(new ParticleEffectFibonacciSphere(Particle.CRIT));
