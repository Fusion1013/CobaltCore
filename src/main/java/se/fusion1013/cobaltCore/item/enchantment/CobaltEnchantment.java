package se.fusion1013.cobaltCore.item.enchantment;
...
public enum CobaltEnchantment implements ICobaltEnchantment {
    ...
    ICobaltEnchantment.EnchantmentTarget[] enchantmentTargets = {ICobaltEnchantment.EnchantmentTarget.ANY};
    ...
    CobaltEnchantment(String internalName, Component name, Component description, int maxLevel, ICobaltEnchantment.EnchantmentTarget... enchantmentTargets) {
        this.internalName = internalName;
        this.name = name;
        this.description = description;
        this.maxLevel = maxLevel;
    ...
    @Override
    public ICobaltEnchantment.EnchantmentTarget[] getEnchantmentTargets() {
