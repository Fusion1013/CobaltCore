...
public class FileUtil {
    ...
    public static YamlConfiguration loadFromPastebin(String pasteId) throws Exception {
        // Step 1: Fetch paste content
        URL url = new URL("https://pastebin.com/raw/" + pasteId);
        ...
        // Step 2: Load into YamlConfiguration
        return YamlConfiguration.loadConfiguration(new StringReader(pasteContent.toString()));
    }
}
