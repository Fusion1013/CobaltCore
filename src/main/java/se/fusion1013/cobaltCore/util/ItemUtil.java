...
public class ItemUtil {
    ...
    private enum CobaltEnchantment {
        ...
        EFFICIENCY(5, 5, Enchantment.EFFICIENCY),
        SHARPNESS(5, 5, Enchantment.SHARPNESS),
        FORTUNE(5, 3, Enchantment.FORTUNE),
        UNBREAKING(5, 3, Enchantment.UNBREAKING),
        LOOTING(5, 3, Enchantment.LOOTING),
        FEATHER_FALLING(5, 4, Enchantment.FEATHER_FALLING),
        POWER(5, 5, Enchantment.POWER),
        INFINITY(5, 1, Enchantment.INFINITY, false), // TODO: Higher levels of infinity allow for infinite tipped arrows (level 2: Spectral Arrows, level 3: All Tipped) (??)
        RESPIRATION(5, 3, Enchantment.RESPIRATION),
        ...
        FIRE_PROTECTION(3, 4, Enchantment.FIRE_PROTECTION),
        PROJECTILE_PROTECTION(3, 4, Enchantment.PROJECTILE_PROTECTION),

        IMPALING(2, 5, Enchantment.IMPALING),
        BLAST_PROTECTION(2, 4, Enchantment.BLAST_PROTECTION),

        FROST_WALKER(1, 2, Enchantment.FROST_WALKER),

        BANE_OF_ARTHROPODS(0, 5, Enchantment.BANE_OF_ARTHROPODS),
