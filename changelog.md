...
**CobaltCore Version 1.6.1**

- **FEATURE:** Added support for ORMLite
...
- **FEATURE:** Introduced Item Toggles
- **FEATURE:** New Item Toggle: DenyContainer
- **COMMANDS:** New command: '/edit item getinfo'
- **COMMANDS:** New command: '/csummon [entity]'
- **COMMANDS:** New command: '/centity [list]'
- **UPDATE:** Moved Glowing and CanDespawn attributes to the Item Toggle System
- **UPDATE:** Renamed CanDespawn attribute to Persistent
- **BUGFIX:** Potential fix for Custom Item data loss

**CobaltCore Version 1.0.1**

- **FEATURE:** Added glowing attribute to Custom Items
- **FEATURE:** Added canDespawn attribute to Custom Items
- **UPDATE:** Set glowing and canDespawn attributes for several items
- **BUGFIX:** Custom Items do not get updated when spawned into the world as entities

**CobaltCore Version 1.0.0**

**CobaltCore Version 0.2**

- **FEATURE:** Added '/cgive pastebin [id]' command
- **FEATURE:** Added '/cobalt reload' command
- **FEATURE:** Added '/edit item model [model]' command
- **FEATURE:** Added '/edit item name [name]' command

**CobaltCore Version 0.1**
